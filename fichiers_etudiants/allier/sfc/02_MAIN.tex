...
\begin{tikzpicture}[
  ...
  \node[sfcstep] (s65542) at (4.00,7.00) {Step\_5};
  ...
  \draw (4.00,6.00) -- (4.00,7.00);
  \draw (4.00,7.00) -- (4.00,8.00);
  \draw (4.00,8.00) -- (4.00,9.00);
  \draw (4.00,9.00) -- (4.00,10.00);
  \draw (5.00,2.00) -- (5.00,3.00);
  \draw (5.00,3.00) -- (5.00,4.00);
  \draw[sfclink] (4.00,10.00) -- (4.50,11.00) -- (3.50,11.00) -- (3.50,1.00) -- (4.50,1.00) -- (4.00,1.00);
  \draw[sfclink] (5.00,4.00) -- (5.00,8.00);
\end{tikzpicture}
\end{document}
